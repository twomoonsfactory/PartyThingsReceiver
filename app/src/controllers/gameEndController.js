export default function($scope, $log, $location, stateManager, gameStates, playerStates, eventService, gameEvents, messageProvider, messageNames, playerHandler, gameDriver){
	$scope.readyPlayers = [];
	$scope.joinedPlayers = [];
