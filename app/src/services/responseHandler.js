export default class responseHandler{
  constructor(eventService, response, gameEvents, gameStates, playerHandler, responseProvider, $log){
    //local variables
    this.responses = [];
    ...
    this.log = $log;
    //event subscriptions
    this.eventService.subscribe(this.gameStates.RoundEnd, this.freshResponses);
    this.eventService.subscribe(this.gameStates.PromptChosen, this.freshResponses);
  }
  newResponse(args){
    this.responses[this.responseCounter] = new this.response(args.response, this.responseCounter, args.playerId);
...
responseHandler.$injector = ['eventService', 'response', 'gameEvents', 'gameStates', 'playerHandler', 'responseProvider', '$log'];
